...
namespace TimedMathQuiz_PE9_2
{
    // Class: Program
    // Author: David Schuh (for the entire math quiz solution portion) and Ajay Ramnarine (for implementing the timer)
    // Purpose: Add a timer to the Math Quiz solution code
    // Restrictions: None
    class Program
    {
        ...
        // Method: Main
        // Purpose: Ask the user for their name and how many questions they want to answer
        //          Prompt the user for difficulty setting
        //          Prompt the user a math question, scoring if they get a point, or marking the question as incorrect if they get the question wrong
        //          or wrong if the timer elapses
        //          Return the amount of questions the user got correct
        // Restrictions: Need to press enter after time elapses to continue with the next question of the quiz
        ...
        start:
            ...
            // set the timer to fire repeated results until stopped
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                // else output stark answer or tell the user their time ran out
        ...
        private static void OnTimedEvent(Object source, System.Timers.ElapsedEventArgs e) 
        {
            Console.BackgroundColor = ConsoleColor.Black;
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("Your time ran out! Press enter to continue with the quiz.");
            timer.Stop();
        }
    }
}
