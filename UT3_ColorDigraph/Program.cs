...
namespace UT3_ColorDigraph
{
    ...
    static class Program
    {
        ...
        static void DFSUtil(int nCurrentVertex, ref bool[] visitedColors) 
        {
            ...
            int[] thisColorList = colorLGraph[nCurrentVertex];
