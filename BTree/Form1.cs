...
namespace BTree
{
    public partial class Form1 : Form
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            // inserting random numbers between 1(inclusive) and 51(exclusive)
            for (int i = 0; i < 30; ++i)
            {
        ...
        private void Button5_Click(object sender, EventArgs e)
        {
            ...
            // priming the tree with numbers btwn 1 and 51 with 7 distributed data points
        ...
        private void Button7_Click(object sender, EventArgs e)
        {
            ...
            // inserting the 15 random letters
            node = new BTree("M", root);
            node = new BTree("A", root);
            node = new BTree("J", root);
            node = new BTree("Y", root);
            node = new BTree("R", root);
