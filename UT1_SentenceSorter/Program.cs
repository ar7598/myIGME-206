...
namespace UT1_SentenceSorter
{
    // Class: Program
    // Author: Ajay Ramnarine
    // Purpose: Modify the Number Sorter application so that it takes sentences instead and sorts the words
    // Restrictions: None
    class Program
    {
        ...
        // Method: Main
        // Purpose: Ask the user to enter a sentence
        //          Ask the user if they would like to sort the words in the sentence in (a)scending or (d)escending order
        //          Sort the words of the sentence and then return the sentence to the console
        // Restrictions: None
        ...
        start:
            ...
            string[] aUserSentence = userSentence.Split(' ');
            ...
            foreach (string word in aUserSentence)
            {
            ...
            foreach (string word in aUserSentence)
            {
                ...
                aUnsorted[nUnsortedLength] = word;
