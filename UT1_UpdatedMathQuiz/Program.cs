...
namespace UT1_UpdatedMathQuiz
{
    // Class: Program
    // Author: Ajay Ramnarine
    // Purpose: Include divion in the Math Quiz Application
    // Restrictions: None
    class Program
    {
        // Method: Main
        // Purpose: Prompt the user to ask if they would like to take a math quiz
        //          Give them 3 difficulties to choose from and also ask how many questions they would like to answer
        //          Make sure to tell the user to round quotients to 2 decimal places
        //          After the quiz, tell the user the amount of questions they got correct, as well as asking if they would like to take the quiz again
        // Restrictions: None
        static void Main(string[] args)
        {
            ...
            // operands and solution, replace with doubles to account for division
            double val1 = 0;
            double val2 = 0;
            double nAnswer = 0;

            // string and int for the response, nResponse should be a double to account for division
            string sResponse = "";
            double nResponse = 0;
        ...
        start:
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                else if(nOp == 2) 
                {
                    ...
                    // round nAnswer to 2 decimal places
                    nAnswer = Math.Round(nAnswer,2);

                    sQuestions = $"Question #{nCntr + 1}: {val1} / {val2} (Enter answer up to 2 decimal places) => ";
                }
                else
                {
                    nAnswer = val1 * val2;
