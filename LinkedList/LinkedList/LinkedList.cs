    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button2__Click(object sender, EventArgs e)
        {
            ...
            while(linkedListNode != null) 
            {
                // add the current linkedListNode to the reverseLinkedList
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            // create a string variable that has the words and then split the words into the string array
            string s = "the fox jumped over the dog";
            sentence = s.Split(' ');

            // create linkedList from the sentence string array
            ...
            // find the node that has the value of fox
            linkedListNode = linkedList.Find("fox");

            // add "quick" and "brown" before that node
            ...
            // find the last occurance of "the"
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // create a string based on the two sentences and then split them into the string array s
            string sentenceOne = "Because I'm sad Clap along if you feel like a room without a roof\n Because I'm sad Clap along if you feel like sadness is the truth sad";
            s = sentenceOne.Split(' ');

            // add the values of s to the linkedList
            ...
            // set linkedListNode to the first value of the linkedList
            linkedListNode = linkedList.First;

            // walk forward through the linkedList and replace the above values
            while(linkedListNode != null) 
            {
                // find and replace values of "sad" with "happy" or "sadness" with "happiness"
                if ((string)linkedListNode.Value == "sad")
                {
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            // create a string variable that contains the sentence
            string sentence = "The Spain in rain falls plain on the mainly";

            // split the sentence into the string array s
            s = sentence.Split(' ');

            // set the linkedList to the values of the string array s
            linkedList = new LinkedList<object>(s);
